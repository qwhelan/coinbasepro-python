...
class OrderBook(WebsocketClient):
    def __init__(self, product_id="BTC-USD", log_to=None):
        super(OrderBook, self).__init__(products=product_id, channels=["full"])
    ...
    def on_sequence_gap(self, gap_start, gap_end):
        self.reset_book()
        print(
            "Error: messages missing ({} - {}). Re-initializing  book at sequence.".format(
